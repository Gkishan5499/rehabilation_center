    ...
    <footer className="bg-medical-dark text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="font-bold text-xl block leading-tight">Prime</span>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Healing Avenue, Health District, Metropolis, State, 10001</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-medical-primary shrink-0" />
                <a href="tel:+15551234567" className="hover:text-medical-primary-light transition-colors">+1 (555) 123-4567</a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Prime Physiotherapy. All rights reserved.</p>
